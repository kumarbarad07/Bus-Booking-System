...
<body>
    ...
    %>
        <div>
        	<a class="mb-0 text-warning fw-semibold text-decoration-none">Welcome, <%= username %></a>
                        ...
                        <div class="col-xl-6 ps-xl-5">
                            <div class="h-text text-center text-xl-start">
                                <h2 class="text-capitalize text-light lh-1 geologica fw-bold charter-text p-2">Charter
                                    ...
                                    journey</h2>
                                <p class="text-light pt-2 pt-xl-3 p-3 p-xl-1 fs-5">Your time is precious. So is your journey.
									That’s why we offer real-time booking, instant confirmation, and smooth travel – every time.</p>
                                <div class="text-xl-center mt-5">
                                    <a href="<%= session.getAttribute("username") != null ? "busBooking.jsp" : "login.jsp" %>"  class="text-decoration-none get-start border-0 rounded-2 fw-bold mt-xl-4 px-4 py-3"><i class="bi bi-arrow-up-right"></i> Get Started</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="m-2">
                                            ...
                                            <input type="date" class="px-3 py-2 rounded-2 border border-opacity-25"
                                                name="" id="date" min="2025-04-25" max="2025-06-24">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="m-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="m-2">
                                            ...
                                            <input type="number" class="px-3 py-2 rounded-2 border border-opacity-25"
                                                name="" id="quantity"  maxlength="35">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="m-3">
                                            <a type="button" href="<%= session.getAttribute("username") != null ? "busBooking.jsp" : "login.jsp" %>"
                                                class="get-start border-0 fw-semibold mt-3 px-4 py-2 text-decoration-none text-black" href="login.jsp"><i
